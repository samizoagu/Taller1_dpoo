...
public class Gasolinera
{
    ...
    public int venderGasolinaPorPrecio(String nombreTipoGasolina, int valorSolicitado, int numeroSurtidor) { 
        // Obtener el tipo de gasolina
        TipoGasolina tipo = tiposGasolina.get(nombreTipoGasolina);
        
        // Asegurarse de que la división sea precisa, convirtiendo el valor solicitado a double
        double precioPorGalon = tipo.getPrecioPorGalon();
        double cantidadSolicitada = (double) valorSolicitado / precioPorGalon;

        // Ahora usamos la cantidad solicitada con precisión
        int precioRealPagado = venderGasolinaPorCantidad(nombreTipoGasolina, cantidadSolicitada, numeroSurtidor);

        return precioRealPagado;
    }
